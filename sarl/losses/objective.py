...
class SARLObjective(nn.Module):
    ...
    def forward(self, phi_x: torch.Tensor, y: torch.Tensor, e: torch.Tensor, predictions: torch.Tensor,
        ...
        violations = self.violations(phi_x, y, e, predictions=predictions)
    ...
    def compute_violations_only(self, phi_x: torch.Tensor, y: torch.Tensor, e: torch.Tensor,
                                predictions: Optional[torch.Tensor] = None) -> StructureViolation:
        return self.violations(phi_x, y, e, predictions=predictions)
